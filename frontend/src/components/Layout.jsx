...
const Layout = ({
  ...
  if(isStatusPreviewOpen){
    return statusPreviewContent;
  }
  return (
    <div
      className={` max-h-screen ${
        theme === "dark" ? "bg-[#111b21] text-white" : "bg-pink-100 text-black"
      } flex relative`}
    >
      {!isMobile && <Sidebar />}
      <div
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          ...
          >
            ...
            <div className="space-y-4">
              <label className="flex items-center space-x-3 cursor-pointer">
                <input
                  ...
                  className="from-radio text-black"
                />
                <span>Light</span>
              </label>
              <label className="flex items-center space-x-3 cursor-pointer">
            ...
            <button
              ...
              className="mt-6 w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-600 transtion duration-200"
            >
              Close
            </button>
          </div>
